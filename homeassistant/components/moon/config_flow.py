"""Config flow for moon integration."""
...
class MoonFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Config flow for moon integration."""
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            return self.async_create_entry(title="Moon phases", data=user_input)
